...
public class PermissionUtils {
    ...
    static String[] permissionsHint ={"没有此权限，无法开启这个功能，请开启权限。PERMISSION_RECORD_AUDIO",
...
//            Toast.makeText(activity, "opened:" + requestPermissions[requestCode], Toast.LENGTH_SHORT).show();
    ...
    public static void requestPermissionsResult(final Activity activity, final int requestCode, @NonNull String[] permissions,
                                                @NonNull int[] grantResults, String hintMsg,PermissionGrant permissionGrant) {
        ...
        if (grantResults.length == 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            if(TextUtils.isEmpty(hintMsg))
            {
                ...
                openSettingActivity(activity,   hintMsg);
            }
